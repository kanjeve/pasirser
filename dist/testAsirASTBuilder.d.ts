...
export declare class AsirASTBuilder extends AbstractParseTreeVisitor<ast.ASTNode | undefined> implements testVisitor<ast.ASTNode | undefined> {
    private createIndeterminateNode;
    ...
    visitIndExpr(ctx: IndExprContext): ast.ExpressionNode;
    visitReal(ctx: RealContext): ast.NumberLiteralNode;
    visitIdExpr(ctx: IdExprContext): ast.ExpressionNode;
    ...
    visitV2Id(ctx: V2IdContext): ast.IndeterminateNode;
    visitBef(ctx: BefContext): ast.IndeterminateNode;
    visitBefN(ctx: BefNContext): ast.IndeterminateNode;
