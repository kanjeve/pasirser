...
export declare class testParser extends antlr.Parser {
    ...
    static readonly RULE_functionModule = 13;
    static readonly RULE_expr = 14;
    static readonly RULE_assignmentExpr = 15;
    static readonly RULE_ternaryExpr = 16;
    static readonly RULE_quoteExpr = 17;
    static readonly RULE_qeNotExpr = 18;
    static readonly RULE_qeOrExpr = 19;
    static readonly RULE_qeAndExpr = 20;
    static readonly RULE_qeCompareExpr = 21;
    static readonly RULE_orExpr = 22;
    static readonly RULE_andExpr = 23;
    static readonly RULE_compareExpr = 24;
    static readonly RULE_addSubExpr = 25;
    static readonly RULE_mulDivSurExpr = 26;
    static readonly RULE_unaryExpr = 27;
    static readonly RULE_powerExpr = 28;
    static readonly RULE_factExpr = 29;
    static readonly RULE_prefixExpr = 30;
    static readonly RULE_postfixExpr = 31;
    static readonly RULE_indexAccessExpr = 32;
    static readonly RULE_memberAccessExpr = 33;
    ...
    memberAccessExpr(): MemberAccessExprContext;
...
export declare class MemberAccessExprContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    get ruleIndex(): number;
    copyFrom(ctx: MemberAccessExprContext): void;
}
export declare class MemberAccessContext extends MemberAccessExprContext {
    constructor(ctx: MemberAccessExprContext);
    primaryExpr(): PrimaryExprContext;
    ARROW(): antlr.TerminalNode[];
    ARROW(i: number): antlr.TerminalNode | null;
    indeterminate(): IndeterminateContext[];
...
export declare class FunctorCallExprContext extends PrimaryExprContext {
    _callee?: ExprContext;
    _args?: ExprlistContext;
    _optionPair?: OptionPairContext;
    _options: OptionPairContext[];
...
export declare class GenNumContext extends NumContext {
    constructor(ctx: NumContext);
    AEGEN(): antlr.TerminalNode;
    enterRule(listener: testListener): void;
    exitRule(listener: testListener): void;
    accept<Result>(visitor: testVisitor<Result>): Result | null;
}
